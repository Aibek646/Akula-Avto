...
const AddListing = () => {
  ...
  const handleRemoveImageUrls = (index: number) => {
    ...
    <main className="container mx-auto px-4 pt-3 pb-8">
      <div className="max-w-4xl mx-auto pt-5">
        <Card className="!bg-transparent shadow-none border-none">
          <CardHeader className="flex items-center justify-center bg-red-100 rounded-[8px] p-4 mb-4">
                  ...
                  >
                    <div className="space-y-2 pt-3">
                      ...
                      <div className="text-sm text-[#6c8ea0]">
                        ...
                        First picture - it the title picture.
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-start mt-2">
                      <FileUploader onFileUrlsReceived={handleImageUrls}>
                        <ScrollArea
                          className="w-96 whitespace-nowrap ml-3
                        "
                        >
