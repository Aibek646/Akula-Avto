...
interface UseFileUploaderProps {
  ...
  onImageUrlsReceived: (fileUrls: string[]) => void;
}
...
const useFileUploader = ({
  ...
  const {getRootProps, getInputProps, isDragActive,fileRejections} =  useDropzone({
    ...
    return {
    getRootProps,getInputProps,isDragActive,fileRejections,files,uploading,uploadProgress
  }
};
